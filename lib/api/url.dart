const baseUrl = "https://mpayy.dbzapps.com/api/";
...
const resendOTPUrl = "access/MobileAppResendOTP";
const otpVerficationUrl = "MobileAppVerification";
const logoutUrl = "DeviceLogoff";
const notificationUrl = "Communication/GetNotification";
const retailerBalanceUrl =
    "GetWalletBalance"; //use this for checking current balance for any user
