...
class SADistributorController extends GetxController {
  TextEditingController searchController = TextEditingController();
  int userId = -1;
  final _box = GetStorage();

  RxList<RetailerResponseReturnData> distributorDetails = RxList();
    ...
    if (await isNetConnected()) {
      ...
      if (distributorDetailsResponse != null &&
        ...
        if (distributorDetailsResponse.returnData.isNotEmpty) {
          distributorDetails(distributorDetailsResponse.returnData);
          temp = distributorDetailsResponse.returnData;
