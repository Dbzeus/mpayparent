...
import 'package:mpayparent/screens/sales/sa_dmt_transaction_report/sa_dmt_report_controller.dart';
...
class SADmtReportScreen extends GetView<SADmtReportController> {
  SADmtReportScreen({Key? key}) : super(key: key);

  @override
  final controller = Get.put(SADmtReportController());
